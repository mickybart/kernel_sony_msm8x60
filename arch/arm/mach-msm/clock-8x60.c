...
#ifndef CONFIG_MACH_SEMC_NOZOMI_OC_NO
...
#ifdef CONFIG_SONY_CAM_SUB_V4L2
	CLK_LOOKUP("csi_clk",		csi1_clk.c,		"1-0048"),
#else
...
#ifdef CONFIG_SONY_CAM_SUB_V4L2
	CLK_LOOKUP("csi_vfe_clk",	csi1_vfe_clk.c,	"1-0048"),
#else
...
#ifdef CONFIG_SONY_CAM_SUB_V4L2
	CLK_LOOKUP("csi_pclk",		csi1_p_clk.c,		"1-0048"),
#else
